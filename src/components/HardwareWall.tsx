...
const features = [
  { name: "Private keys location", hot: "On internet-connected device", cold: "Offline, on secure chip" },
  { name: "Vulnerability to phishing", hot: "High - always connected", cold: "Very Low - requires physical confirmation" },
  { name: "Malware protection", hot: "Relies on device security", cold: "Immune - isolated environment" },
  { name: "Transaction signing", hot: "Software-based", cold: "Hardware-based, visible on device" },
  { name: "Recovery if device lost", hot: "Seed phrase (if saved)", cold: "Seed phrase + new device" },
  { name: "Best for", hot: "Small amounts, frequent use", cold: "Long-term storage, large amounts" },
];
...
const HardwareWall = () => {
  ...
  return (
    <section id="hardware" className="py-24 md:py-32 relative bg-secondary/30">
      ...
      <div className="container px-4 md:px-6 relative">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-bold font-display mb-4">
            The <span className="gradient-text">Hardware Wall</span>
          </h2>
          ...
          <div className="inline-flex p-1 rounded-xl bg-secondary/50 border border-border/50">
            <button
              ...
              className={cn(
                ...
                activeType === "hot"
                  ? "bg-alert text-alert-foreground shadow-lg"
        ...
        >
          ...
          <div
            className={cn(
              "flex items-center justify-center gap-3 p-4 rounded-t-2xl border border-b-0 transition-colors duration-500",
              activeType === "hot"
