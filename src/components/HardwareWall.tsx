...
const features = [{
  ...
  hot: "On an internet-connected device",
  ...
  hot: "Depends on the security of the host device",
  cold: "Protected — offline and isolated"
  },
  {
...
const HardwareWall = () => {
  ...
  return <section id="hardware" className="py-20 md:py-28 relative bg-secondary/30">
      ...
      <div className="container px-4 md:px-6 relative">
        ...
        {/* Pro tip - removed animate-pulse-glow */}
